...
<vTransition>
  <div v-if="isshow" class="">
    <p>非常荣幸为这篇论文写了解读，发在BioArt公众号上: Nature | 脑机接口重大进展——深度学习解码脑电波合成语音。本人不是神经科学领域的博士生，但对深度学习神经网络略有所知，为了写这篇解读也翻阅了不少文献。如有谬误还请各位脑科学和信号处理方面的大佬不吝指正。
</p>
<p>
  Nature | 脑机接口重大进展——深度学习解码脑电波合成语音
</p>
...
作者：知乎用户
链接：https://www.zhihu.com/question/321658258/answer/664590679
来源：知乎
著作权归作者所有。商业转载请联系作者获得授权，非商业转载请注明出处。</p>

  </div>
</vTransition>
    <button @click="show">不定高收起和展开</button>
  </div>
</template>
<script type='text/ecmascript-6'>
import VTransition from 'Components/vTransition/vTransition.js'
export default {
  name: 'customVTransition',
  components:{
    VTransition
  },
  data() {
